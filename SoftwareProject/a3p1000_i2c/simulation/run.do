...
quietly set PROJECT_DIR "D:/FPGA/a3p1000_i2c"
...
vlog "+incdir+${PROJECT_DIR}/stimulus" -vlog01compat -work postsynth "${PROJECT_DIR}/stimulus/RX_test.v"

vsim -L proasic3 -L postsynth -L COREAPB3_LIB  -t 1ps postsynth.RX_test
add wave /RX_test/*
run 1ms
